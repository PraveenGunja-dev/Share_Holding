  ...
  return (
    <div className="space-y-4 transition-all duration-300">
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-4 border-b border-border pb-2 mb-3">
        <div className="pb-1">
          <h2 className="text-xl 2xl:text-2xl font-[1000] text-primary dark:text-sky-400 tracking-tighter leading-none mb-0.5 shadow-sm inline-block">Top Mutual Funds</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
          <Card className="p-2.5 bg-card border border-border shadow-sm flex flex-col shrink-0 border-r-4 border-r-amber-500">
            <div className="text-[8px] 2xl:text-[9px] font-bold text-muted-foreground tracking-widest mb-0.5 leading-none px-0">Total MF holdings</div>
          ...
          <Card className="p-2.5 bg-card border border-border shadow-sm flex flex-col shrink-0 border-r-4 border-r-amber-600">
            <div className="text-[8px] 2xl:text-[9px] font-bold text-muted-foreground tracking-widest mb-0.5 leading-none">Active MF holdings</div>
          ...
          <Card className="p-2.5 bg-card border border-border shadow-sm flex flex-col shrink-0 border-r-4 border-r-emerald-500">
            <div className="text-[8px] 2xl:text-[9px] font-bold text-muted-foreground tracking-widest mb-0.5 leading-none">Passive MF holdings</div>
          ...
          <Card className="p-2.5 bg-card border border-border shadow-sm flex flex-col justify-center gap-1 shrink-0">
            <div className="flex justify-between items-center text-[9px] 2xl:text-[10px] font-bold text-muted-foreground tracking-widest">
            ...
            <div className="flex justify-between items-center pt-1 border-t border-border/50 text-[9px] 2xl:text-[10px] font-bold text-muted-foreground tracking-widest">
              <span>Change</span>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-x-4 gap-y-6 w-full">
          <div className={cn("relative w-full flex flex-col items-center", isLargeTopN ? "h-auto" : pieRadii.containerH)}>
            <div className="absolute top-0 w-full flex justify-center z-10 pointer-events-none py-1 text-center">
              <h3 className="text-xs 2xl:text-sm font-black text-primary dark:text-sky-400 tracking-widest">Top Active MF Investors</h3>
            </div>
            ...
            {isLargeTopN && (
              <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2 w-full px-2">
                {activeChartData.map((item, idx) => (
                  <div key={idx} 
                    className={cn(
                      "flex items-center gap-2 p-1 border-b border-border/30 text-[10px] font-bold transition-all duration-200 cursor-pointer rounded",
          ...
          <div className={cn("relative w-full flex flex-col items-center", isLargeTopN ? "h-auto" : pieRadii.containerH)}>
            <div className="absolute top-0 w-full flex justify-center z-10 pointer-events-none py-1 text-center">
              <h3 className="text-xs 2xl:text-sm font-black text-primary dark:text-sky-400 tracking-widest">Top Passive MF Investors</h3>
            </div>
            <div className={cn("w-full shrink-0", pieRadii.containerH)}>
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
      ...
      <Card className="p-4 md:p-6 bg-card shadow-xl border-border">
        <div className="grid grid-cols-1 2xl:grid-cols-2 gap-12 w-full">
          <div className="space-y-4">
            <h3 className="text-base font-black text-primary dark:text-sky-400 tracking-widest border-l-4 border-blue-500 pl-3">Top {topN} Active MF Investors</h3>
                ...
                <Table>
                  <TableHeader className="bg-primary dark:bg-slate-900 transition-colors sticky top-0 z-10 shadow-sm">
                    <TableRow className="hover:bg-transparent border-b border-white/10">
                      ...
                      <TableHead rowSpan={2} className="text-white font-bold border-r border-white/5 whitespace-normal py-4 w-[30%]">Shareholder Name</TableHead>
                      ...
                      <TableHead rowSpan={2} className="text-center text-white font-bold py-4 whitespace-normal leading-tight">Change in Holding Shares</TableHead>
                    </TableRow>
                  ...
                  <TableBody className="bg-card">
                      {activeChartData.map((row, idx) => (
                        ...
                        >
                          ...
                          <TableCell className="font-bold text-[12px] 2xl:text-[14px] text-primary dark:text-sky-300 border-r border-border py-4 leading-tight whitespace-normal w-[30%]">{row.name}</TableCell>
          ...
          <div className="space-y-4">
            <h3 className="text-base font-black text-primary dark:text-sky-400 tracking-widest border-l-4 border-emerald-500 pl-3">Top {topN} Passive MF Investors</h3>
            <div className="border border-border rounded-xl shadow-xl overflow-hidden flex flex-col">
              <div className="w-full max-h-[500px] overflow-y-auto custom-scrollbar relative">
                <Table>
                  <TableHeader className="bg-primary dark:bg-slate-900 transition-colors sticky top-0 z-10 shadow-sm">
                    <TableRow className="hover:bg-transparent border-b border-white/10">
                      ...
                      <TableHead rowSpan={2} className="text-center text-white font-bold py-4 whitespace-normal leading-tight">Change in Holding</TableHead>
                    </TableRow>
                    <TableRow className="hover:bg-transparent text-[9px] 2xl:text-[10px] border-b border-white/10">
                      <TableHead className="text-center text-white/80 font-bold border-r border-white/5 py-2.5 whitespace-normal bg-sky-400/20">Holdings (L)</TableHead>
                      <TableHead className="text-center text-white/80 font-bold border-r border-white/5 py-2.5 whitespace-normal leading-tight">% of Share Capital</TableHead>
