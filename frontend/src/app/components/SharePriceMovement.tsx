...
export function SharePriceMovement({ dateRange }: SharePriceProps) {
  ...
  const chartHeight = viewportWidth < 768 ? 260 : viewportWidth < 1400 ? 320 : 360;
    ...
    <div id="price" className="space-y-6 transition-all duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="px-5 py-4 bg-card border-border border-l-4 border-l-emerald-500 shadow-xl">
          <div className="text-[13px] font-black text-emerald-500 uppercase tracking-widest mb-1.5">Current Price (APL)</div>
        ...
        <Card className="px-5 py-4 bg-card border-border shadow-xl">
          <div className="text-[13px] font-black text-muted-foreground uppercase tracking-widest mb-1.5">Week High</div>
        ...
        <Card className="px-5 py-4 bg-card border-border shadow-xl">
          <div className="text-[13px] font-black text-muted-foreground uppercase tracking-widest mb-1.5">Avg. % Delivery</div>
