  ...
  return (
    <div id="aifs" className="space-y-6 transition-all duration-300">
      ...
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-4 border-b border-border pb-2 mb-3">
        <div className="pb-1">
          <h2 className="text-xl 2xl:text-2xl font-[1000] text-primary dark:text-sky-400 tracking-tighter leading-none mb-0.5 shadow-sm inline-block">Top AIFs</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          <Card className="p-2.5 bg-card border border-border shadow-sm flex flex-col shrink-0 border-r-4"
            ...
            <div className="text-[8px] 2xl:text-[9px] font-bold text-muted-foreground tracking-widest mb-0.5 leading-none">Total AIF holdings</div>
            <div className="text-base 2xl:text-lg font-black" style={{ color: getCategoryColor('DII-AIF') }}>
      ...
      <Card className="p-4 bg-card border-border shadow-xl overflow-hidden">
        <div className="flex flex-col xl:flex-row gap-8">
          ...
          <div className="xl:w-[72%] py-4">
            <div className="mb-4">
              <h3 className="text-base 2xl:text-lg font-black text-primary dark:text-sky-400 mb-2 tracking-widest opacity-90 border-l-4 border-sky-500 pl-3">Top {topN} DII - AIFs​</h3>
            </div>
                  ...
                  <Table>
                    <TableHeader className="bg-primary dark:bg-slate-900 transition-colors sticky top-0 z-20 shadow-sm">
                      <TableRow className="hover:bg-transparent border-b border-white/10">
                        ...
                        <TableHead rowSpan={2} className="text-white font-bold border-r border-white/5 whitespace-normal py-4 w-[25%]">Shareholder Name</TableHead>
                        ...
                        <TableHead rowSpan={2} className={cn("text-center text-white font-bold py-4 whitespace-normal leading-tight max-w-[100px] transition-colors", metricView === 'change' ? "bg-white/20" : "")}>Change in Holding Shares</TableHead>
                      </TableRow>
                    ...
                    <TableBody className="bg-card">
                      {processedData.slice(0, topN).map((row: any, idx: number) => (
                        ...
                        >
                          ...
                          <TableCell className="font-bold text-[12px] 2xl:text-[14px] text-primary dark:text-sky-300 border-r border-border py-4 leading-tight whitespace-normal w-[25%]">{row.name}</TableCell>
